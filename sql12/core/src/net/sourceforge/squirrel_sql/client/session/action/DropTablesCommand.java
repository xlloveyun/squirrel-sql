...
public class DropTablesCommand implements ICommand
{
	...
	static interface i18n
	{
		...
		String PROGRESS_DIALOG_TITLE = s_stringMgr.getString("DropTablesCommand.progressDialogTitle");
	 ...
	 */
	public DropTablesCommand(IObjectTreeAPI tree, List<ITableInfo> tables)
	{
		super();
	...
	private class DeleteExecuter implements Runnable
	{
		...
		public void run()
		{
			...
			for (ITableInfo ti : orderedTables)
			{
				...
				buf.append("DROP TABLE ").append(ti.getQualifiedName());
