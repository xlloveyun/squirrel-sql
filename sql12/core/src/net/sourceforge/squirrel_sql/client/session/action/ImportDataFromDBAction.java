 ...
 */
public class ImportDataFromDBAction extends SquirrelAction
								implements IObjectTreeAction
{
    ...
    private static final StringManager s_stringMgr =
        StringManagerFactory.getStringManager(ImportDataFromDBAction.class);
	 ...
	 */
	public ImportDataFromDBAction(IApplication app)
	{
		super(app);
	}
	...
	public void actionPerformed(ActionEvent evt)
	{
		...
		if (_tree != null)
		{
			...
			{
					new ImportDataFromDBCommand(app, _tree, selectedObjects[0]).execute();
			}
			else
			{
