 ...
 */
public class ImportDataFromDBCommand implements ICommand
{
	/** Application API. */
	...
	public ImportDataFromDBCommand(IApplication app, IObjectTreeAPI tree,
    ...
    */
	public void execute()
	{
		if (_tree != null)
		{
			...
			winMgr.showImportDataFromDBDialog(_tree, _objectInfo);
		}
	}
}
