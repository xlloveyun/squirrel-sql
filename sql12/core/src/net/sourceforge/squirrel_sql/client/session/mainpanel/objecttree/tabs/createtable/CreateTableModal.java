...
public class CreateTableModal extends JScrollPane {
	...
	private static final StringManager s_stringMgr =
		        StringManagerFactory.getStringManager(CreateTableModal.class);
	...
	static interface i18n
	{
		...
		String Column =s_stringMgr.getString("CreateTableModal.Column");
	...
	private JTabbedPane getJTabbedPane() {
		...
		jTabbedPane.addTab(i18n.Column, columnPan);
		jTabbedPane.addTab(s_stringMgr.getString("CreateTableModal.HBaseOption"), hoPan);
		jTabbedPane.addTab(s_stringMgr.getString("CreateTableModal.PK/STORE"), pkPan);
	...
	private JPanel getPrimaryKeykPan() {
		...
		SmallTabButton upBtn = new SmallTabButton(s_stringMgr.getString("CreateTableModal.MoveColumnUp"), upIcon);
		...
		SmallTabButton downBtn = new SmallTabButton(s_stringMgr.getString("CreateTableModal.MoveColumnDown"), downIcon);
		...
		SmallTabButton deleteBtn = new SmallTabButton(s_stringMgr.getString("CreateTableModal.DeletePKOrStore"), deleteIcon);
		...
		partitionNum.setBounds(437, 10, 116, 21);
		pkPan.add(partitionNum);

		JLabel lblPartitionNum = new JLabel(s_stringMgr.getString("CreateTableModal.PartitionNum"));
		lblPartitionNum.setBounds(330, 13, 97, 15);
		pkPan.add(lblPartitionNum);

		isPartitionCheckBox = new JCheckBox(s_stringMgr.getString("CreateTableModal.IsPartition"));
		isPartitionCheckBox.setBounds(186, 10, 138, 23);
	...
	private JPanel getHbaseOptionPan() {
		...
		SmallTabButton addBtn = new SmallTabButton(s_stringMgr.getString("CreateTableModal.AddNewColumn"), addIcon);
		...
		SmallTabButton delBtn = new SmallTabButton(s_stringMgr.getString("CreateTableModal.DeleteSelectedColumn"), delIcon);
	...
	private JPanel getColumnPan() {
		...
		JLabel tbLabel = new JLabel(s_stringMgr.getString("CreateTableModal.PleaseSelect"));
	...
	private JPanel getTableInfo() {
		JPanel panel;
		JLabel dbConLabel = new JLabel(s_stringMgr.getString("CreateTableModal.DataBaseConnection"));
		JLabel snLabel = new JLabel(s_stringMgr.getString("CreateTableModal.SchemaName"));
		JTextField dbName = new JTextField();
		panel = new JPanel();
		panel.setBorder(new TitledBorder(null,s_stringMgr.getString("CreateTableModal.TableInfo"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		JButton btnExecute = new JButton(s_stringMgr.getString("CreateTableModal.EXECUTE"));
		...
		JButton btnToSql = new JButton(s_stringMgr.getString("CreateTableModal.ViewSql"));
		...
		JLabel lblTableName = new JLabel(s_stringMgr.getString("CreateTableModal.TableName"));
